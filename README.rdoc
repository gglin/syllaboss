...
d- USER model: gravatar/uploadable pic, expand user table to include social media
...
- scrape wikipedia for POTD main page
...
- email notfications (activemailer)
- notifcation box working on page (wow features)
