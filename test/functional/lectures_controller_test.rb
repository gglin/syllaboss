...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { content: @lecture.content, creator: @lecture.creator, file_upload: @lecture.file_upload, title: @lecture.title }
    end
  ...
  test "should update lecture" do
    put :update, id: @lecture, lecture: { content: @lecture.content, creator: @lecture.creator, file_upload: @lecture.file_upload, title: @lecture.title }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
